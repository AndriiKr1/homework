...
Каждый программист  имеет список задач
 Task (int number, String description, String status, int daysInProcessing) . Сформировать Map<Boolean, Task> ,
 где ключу true будут соответствовать задачи находящиеся в обработке (поле daysInProcessing)  менее заданного количества дней, false - остальные
...
Сформировать Map<Integer, Task> , где ключ сколько дней задача в обработке, значение - список задач.
